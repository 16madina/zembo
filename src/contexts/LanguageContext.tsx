...
export const translations = {
  fr: {
    ...
    pushDescription: "Recevoir des alertes pour les vibes, messages et activités",
    ...
    visibleToMatches: "Visible par mes vibes uniquement",
    ...
    matchesOnly: "Mes vibes uniquement",
    ...
    classification18Desc1: "Zembo est une application sociale exclusivement réservée aux personnes majeures (18 ans et plus).",
    ...
    aiConsentRequired: "Tu dois accepter le consentement IA ci-dessus pour accéder à ce jeu.",
     zconnectDesc: "Appel vocal basé sur vos intérêts",
    ...
    basedOnInterests: "Basé sur vos intérêts communs",
     ...
     filterLikedProfilesDesc: "Les profils déjà likés ne réapparaîtront pas dans le feed",
      filterMatches: "Filtrer les vibes",
      filterMatchesDesc: "Les profils déjà en vibe ne réapparaîtront pas dans le feed",
  ...
  en: {
    ...
    pushDescription: "Receive alerts for vibes, messages and activities",
    ...
    visibleToMatches: "Visible to my vibes only",
    ...
    classification18Desc1: "Zembo is a social app exclusively for adults (18 years and older).",
    ...
    aiConsentRequired: "You must accept the AI consent above to access this game.",
     zconnectDesc: "Interest-based voice call",
    ...
    priorityMatches: "Priority vibes",
